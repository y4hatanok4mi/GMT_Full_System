...
const StudentSettingsPage = async () => {
  ...
  return (
    <div className="min-h-screen flex flex-col items-center gap-4 mt-16 bg-slate-200 dark:bg-gray-800 px-4 sm:px-6">
      <div className="flex flex-col gap-4 p-6 mt-8   sm:p-8 bg-slate-100 border-slate-300 dark:bg-gray-900 border dark:border-gray-700 w-full sm:w-4/5 md:w-2/3 lg:w-1/2 rounded-md">
        <div>
