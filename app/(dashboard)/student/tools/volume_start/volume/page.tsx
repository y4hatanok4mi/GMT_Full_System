...
const VolumePage = () => {
  return (
    <div className="min-h-screen bg-gray-100 dark:bg-slate-800 p-4 mt-16 flex flex-col items-center w-full">
      <div className="w-full max-w-5xl lg:w-3/4 mx-auto">
        <h1 className="text-xl sm:text-2xl md:text-3xl font-bold mb-7 text-center text-gray-900 dark:text-white">
